...
public class TTest {
    ...
    private static void placeComponents(JPanel panel) {
        ...
        JLabel jLabel=new JLabel("jComboBox");
        jLabel.setBounds(10, 150, 80, 25);
        JComboBox<String> jComboBox=new JComboBox<>();
        jComboBox.setBounds(90, 150, 80, 25);

        jComboBox.setVisible(true);
        jComboBox.addItem("wer1");
        jComboBox.addItem("2sad");
        jComboBox.addItem("3asdf");
        panel.add(jLabel);
        panel.add(jComboBox);
